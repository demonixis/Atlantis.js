...
Atlantis.SpriteBatch = (function () {
    ...
    spriteBatch.prototype.draw = function (texture2D, destinationRectangle, sourceRectangle, color, rotation, origin, scale, effect, layerDepth) {
        if (this._batchStarted) {
    ...
    spriteBatch.prototype.drawString = function (spriteFont, text, position, color, rotation, original, scale, effect, layerDepth) {
        if (this._batchStarted) {
            this._batchItems.push({ 
