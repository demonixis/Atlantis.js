...
(function() {
	...
	Atlantis.Mouse.prototype.initialize = function(domElement) {
		if (!this.initialized) {
			...
			this.domElement.addEventListener("click", function (e) { that.update(e, that); }e, false);
			...
			this.domElement.addEventListener("touchend", function (e) { that.update(e, that); }e, false);
	...
	function updateDelta = function (instance) {
