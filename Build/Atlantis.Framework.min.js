...
Atlantis.ContentManager.prototype.preload=function(a,b){var c=this.preloader.length,d=0;a="function"===typeof a?a:function(){};b="function"===typeof b?b:function(){};for(var e=function(a){d++},g=0;g<c;g++)this.load(this.preloader[g],e);var f=this,h={status:"Loading",progress:0},l=setInterval(function(){h.progress=100*d/c;d===c&&(clearInterval(l),h.status="Complete",f.preloader.length=0,b());Atlantis.notify(Atlantis.events.ContentPreloading,h);a(h)},Atlantis.ContentManager.PreloadTimerInterval)};
...
Atlantis.TouchPanel=function(a){this._states=[];var b=this,c=function(a){a.preventDefault();var c=a.touches.length;b._states.length=c;for(var g=0;g<c;g++)b._states[g]={x:a.touches[g].clientX,y:a.touches[g].clientY},b._states[g].touchState="touchstart"==a.type?Atlantis.TouchLocationState.Pressed:"touchmove"==a.type?Atlantis.TouchLocationState.Moved:"touchend"==a.type?Atlantis.TouchLocationState.Released:Atlantis.TouchLocationState.Invalid};a.addEventListener("touchstart",c,!1);a.addEventListener("touchmove",
...
Atlantis.SpriteBatch.prototype.drawString=function(a,b,c,d,e,g,f,h,l){this._batchStarted&&this._batchItems.push({type:Atlantis.BatchItemType.Font,spriteFont:a,text:b,destinationRectangle:{x:c.x,y:c.y,width:1,height:1},color:d,rotation:e,origin:g,scale:f,effect:h?h:Atlantis.SpriteEffect.None,layerDepth:"number"===typeof l?l:0})};
...
a()}.bind(this))):(this.loadContent(),a()))};d.prototype.pause=function(){cancelAnimationFrame(a);this._paused=!0};d.prototype.resume=function(){this._paused&&(this._paused=!1,a())};return d}();
