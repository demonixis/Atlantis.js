(function(){for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b,c){var g=(new Date).getTime(),f=Math.max(0,16-(g-a)),k=window.setTimeout(function(){b(g+f)},f);a=g+f;return k});window.cancelAnimationFrame||(window.cancelAnimationFrame=
...
Atlantis.ContentManager.prototype.preload=function(a){var b=this.preloadAssets.length,c=0;a=function(a){c++};for(var d=0;d<b;d++)this.load(this.preloadAssets[d],a);var e={status:"Loading",progress:0},g=setInterval(function(){e.progress=100*c/b;c===b&&(clearInterval(g),e.status="Complete");Atlantis.notify(Atlantis.events.ContentPreloading,e)},Atlantis.ContentManager.PreloadTimerInterval)};
...
Atlantis.Matrix.prototype.invert=function(){var a=this.M31*this.M42-this.M32*this.M41,b=this.M31*this.M43-this.M33*this.M41,c=this.M34*this.M41-this.M31*this.M44,d=this.M32*this.M43-this.M33*this.M42,e=this.M34*this.M42-this.M32*this.M44,g=this.M33*this.M44-this.M34*this.M43,f=this.M22*g+this.M23*e+this.M24*d,k=this.M21*g+this.M23*c+this.M24*b,l=this.M21*-e+this.M22*c+this.M24*a,t=this.M21*d+this.M22*-b+this.M23*a,h=this.M11*f-this.M12*k+this.M13*l-this.M14*t;if(0==Math.abs(h))this.set(this.getZeroValues());
else{var h=1/h,m=this.M11*this.M22-this.M12*this.M21,p=this.M11*this.M23-this.M13*this.M21,n=this.M14*this.M21-this.M11*this.M24,q=this.M12*this.M23-this.M13*this.M22,r=this.M14*this.M22-this.M12*this.M24,s=this.M13*this.M24-this.M14*this.M23,u=this.M12*g+this.M13*e+this.M14*d,g=this.M11*g+this.M13*c+this.M14*b,c=this.M11*-e+this.M12*c+this.M14*a,a=this.M11*d+this.M12*-b+this.M13*a,b=this.M42*s+this.M43*r+this.M44*q,d=this.M41*s+this.M43*n+this.M44*p,e=this.M41*-r+this.M42*n+this.M44*m,v=this.M41*
q+this.M42*-p+this.M43*m,w=this.M32*s+this.M33*r+this.M34*q,s=this.M31*s+this.M33*n+this.M34*p,n=this.M31*-r+this.M32*n+this.M34*m,m=this.M31*q+this.M32*-p+this.M33*m;this.M11=+f*h;this.M12=-u*h;this.M13=+b*h;this.M14=-w*h;this.M21=-k*h;this.M22=+g*h;this.M23=-d*h;this.M24=+s*h;this.M31=+l*h;this.M32=-c*h;this.M33=+e*h;this.M34=-n*h;this.M41=-t*h;this.M42=+a*h;this.M43=-v*h;this.M44=+m*h}};Atlantis.Matrix.invert=function(a){a=new Matrix(a);a.invert();return a};
...
d.prototype.run=function(){this.initialized||(this.initialized=!0,this.initialize(),this.loadContent(),a())};d.prototype.pause=function(){cancelAnimationFrame(a);this._paused=!0};d.prototype.resume=function(){this._paused&&(this._paused=!1,a())};return d}();
