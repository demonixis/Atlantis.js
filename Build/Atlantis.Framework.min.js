...
Atlantis.ContentManager=function(){function a(a,b,c){var d=new Image;d.onload=function(){this.style.position="absolute";this.style.left="-9999px";document.body.appendChild(d);document.body.removeChild(d);this.style.position="";this.style.left="";c(this)};d.src=b;return a[b]=d}function b(a,b,c){var d=document.createElement("audio");d.onload=c;d.src=b;d.controls=!1;return a[b]=d}function c(a,b,c){var d=document.createElement("video");d.onload=c;d.src=b;return a[b]=d}function e(a,b,c,d){Atlantis.ajax({method:"GET",
url:b,success:function(e){var k=e;"json"==c&&(k=JSON.parse(e));a[b]=k;d(a[b])}})}var d=function(a){this.rootDirectory=a||"";this.assets=[]};d.prototype.load=function(d,f){f="function"===typeof f?f:function(){};if(this.assets[d])f(this.assets[d]);else{var h=d.split("."),h=h[h.length-1];d=this.rootDirectory+d;switch(h){case "png":case "jpg":case "bmp":a(this.assets,d,f);break;case "mp3":case "ogg":case "wav":b(this.assets,d,f);break;case "mp4":case "ogv":c(this.assets,d,f);case "xml":case "json":case "js":e(this.assets,
d,h,f)}}return this.assets[d]};d.prototype.setRootDirectory=function(a){this.rootDirectory=a};d.prototype.getRootDirectory=function(){return this.rootDirectory};d.prototype.dispose=function(){this.assets.length=0};return d}();Atlantis=window.Atlantis||{};Atlantis.GameComponent=function(a){this.game=a;this.enabled=!0;this.initialized=!1};Atlantis.GameComponent.prototype.initialize=function(){this.initialized=!0};Atlantis.GameComponent.prototype.update=function(a){};Atlantis.GameComponent.prototype.isEnabled=function(){return this.enabled};Atlantis.GameComponent.prototype.isInitialized=function(){return this.initialized};Atlantis.GameComponent.prototype.setEnabled=function(a){this.enabled=a};
...
Atlantis.ajax=function(a){var b=a||{},c=a.url,e=a.success||function(){},d;"undefined"!==typeof WinJS?WinJS.xhr({url:c}).then(e):(d=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP"),"POST"===b.method?(d.open("POST",c,b.async),d.onreadystatechange=function(){4==d.readyState&&200==d.status&&e(d.responseText)},d.send(b.data)):(a=b.data?[c,"?",b.data].join(""):c,d.open("GET",a,b.async),d.onreadystatechange=function(){4==d.readyState&&e(d.responseText)},d.send(null)))};
Atlantis.notify=function(a,b){var c=document.createEvent("HTMLEvents");c.initEvent(a,!0,!1);if(b instanceof Object)for(var e in b)c[e]=b[e];document.dispatchEvent(c)};Atlantis=window.Atlantis||{};Atlantis.MathHelper={Pi:function(){return Math.PI},PiOver2:function(){return Math.PI/2},PiOver4:function(){return Math.PI/4},TwoPi:function(){return 2*Math.PI},clamp:function(a,b,c){a=a>c?c:a;return a<b?b:a},distance:function(a,b){return Math.abs(a-b)},lerp:function(a,b,c){c=0>c?0:c;return a+(b-a)*(1<c?1:c)},toDegrees:function(a){return 180/Math.PI*a},toRadians:function(a){return Math.PI/180*a},isPowerOfTwo:function(a){return 0<a&&0==(a&a-1)}};Atlantis=window.Atlantis||{};Atlantis.Matrix=function(a){a instanceof Atlantis.Matrix?(a=a.toArray(),this.set(a)):a instanceof Array&&16==a.length?this.set(a):this.M44=this.M43=this.M42=this.M41=this.M34=this.M33=this.M32=this.M31=this.M24=this.M23=this.M22=this.M21=this.M14=this.M13=this.M12=this.M11=0};
...
Atlantis.Matrix.createRotationZ=function(a){var b=this.getMatrixIdentity(),c=Math.cos(a);a=Math.sin(a);b.M11=c;b.M13=a;b.M31=-a;b.M33=c;return b};Atlantis.Matrix.createScale=function(a,b,c){var e=Atlantis.Matrix.getMatrixIdentity();e.M11=a;e.M22=b||a;e.M33=c||a;return e};Atlantis.Matrix.createTranslation=function(a,b,c){var e=Atantis.Matrix.getMatrixIdentity();e.M41=a;e.M42=b||a;e.M43=c||a;return e};
Atlantis.Matrix.createLookAt=function(a,b,c){b=Atlantis.Vector3.subtract(b,a);b.normalize();c=Atlantis.Vector3.cross(c,b);c.normalize();var e=Atlantis.Vector3.cross(b,c);e.normalize();var d=Atlantis.Matrix.getMatrixIdentity();d.M11=c.x;d.M21=c.y;d.M31=c.z;d.M12=e.x;d.M22=e.y;d.M32=e.z;d.M13=b.x;d.M23=b.y;d.M33=b.z;d.M41=-Atlantis.Vector3.dot(c,a);d.M42=-Atlantis.Vector3.dot(e,a);d.M43=-Atlantis.Vector3.dot(b,a);return d};
Atlantis.Matrix.createOrthographic=function(a,b,c,e){var d=new Matrix;d.M11=2/a;d.M12=d.M13=d.M14=0;d.M22=2/b;d.M21=d.M23=d.M24=0;d.M33=1/(c-e);d.M31=d.M32=d.M34=0;d.M41=d.M42=0;d.M43=c/(c-e);d.M44=1;return d};Atlantis.Matrix.createOrthographicOffCenter=function(a,b,c,e,d,g){var f=new Atlantis.Matrix;f.M11=2/(b-a);f.M12=0;f.M13=0;f.M14=0;f.M21=0;f.M22=2/(e-c);f.M23=0;f.M24=0;f.M31=0;f.M32=0;f.M33=1/(d-g);f.M34=0;f.M41=(a+b)/(a-b);f.M42=(e+c)/(c-e);f.M43=d/(d-g);f.M44=1;return f};
Atlantis.Matrix.createPerspectiveFieldOfView=function(a,b,c,e){a=1/Math.tan(0.5*a);b=c/(a/b);a=c/a;return Atlantis.Matrix.createPerspectiveOffCenter(-b,b,-a,a,c,e)};Atlantis.Matrix.createPerspetiveFieldOfViewRH=function(a,b,c,e){a=1/Math.tan(0.5*a);b=c/(a/b);a=c/a;return Matrix.createPerspectiveOffCenterRH(-b,b,-a,a,c,e)};
Atlantis.Matrix.createPerspectiveOffCenter=function(a,b,c,e,d,g){g/=g-d;var f=new Atlantis.Matrix;f.M11=2*d/(b-a);f.M22=2*d/(e-c);f.M31=(a+b)/(a-b);f.M32=(e+c)/(c-e);f.M33=g;f.M34=1;f.M43=-d*g;return f};Atlantis.Matrix.createPerspectiveOffCenterRH=function(a,b,c,e,d,g){a=createPerspectiveOffCenter(a,b,c,e,d,g);a.M31*=-1;a.M32*=-1;a.M33*=-1;a.M34*=-1;return a};
Atlantis.Matrix.prototype.invert=function(){var a=this.M31*this.M42-this.M32*this.M41,b=this.M31*this.M43-this.M33*this.M41,c=this.M34*this.M41-this.M31*this.M44,e=this.M32*this.M43-this.M33*this.M42,d=this.M34*this.M42-this.M32*this.M44,g=this.M33*this.M44-this.M34*this.M43,f=this.M22*g+this.M23*d+this.M24*e,h=this.M21*g+this.M23*c+this.M24*b,l=this.M21*-d+this.M22*c+this.M24*a,t=this.M21*e+this.M22*-b+this.M23*a,k=this.M11*f-this.M12*h+this.M13*l-this.M14*t;if(0==Math.abs(k))this.set(this.getZeroValues());
else{var k=1/k,m=this.M11*this.M22-this.M12*this.M21,p=this.M11*this.M23-this.M13*this.M21,n=this.M14*this.M21-this.M11*this.M24,q=this.M12*this.M23-this.M13*this.M22,r=this.M14*this.M22-this.M12*this.M24,s=this.M13*this.M24-this.M14*this.M23,u=this.M12*g+this.M13*d+this.M14*e,g=this.M11*g+this.M13*c+this.M14*b,c=this.M11*-d+this.M12*c+this.M14*a,a=this.M11*e+this.M12*-b+this.M13*a,b=this.M42*s+this.M43*r+this.M44*q,e=this.M41*s+this.M43*n+this.M44*p,d=this.M41*-r+this.M42*n+this.M44*m,v=this.M41*
q+this.M42*-p+this.M43*m,w=this.M32*s+this.M33*r+this.M34*q,s=this.M31*s+this.M33*n+this.M34*p,n=this.M31*-r+this.M32*n+this.M34*m,m=this.M31*q+this.M32*-p+this.M33*m;this.M11=+f*k;this.M12=-u*k;this.M13=+b*k;this.M14=-w*k;this.M21=-h*k;this.M22=+g*k;this.M23=-e*k;this.M24=+s*k;this.M31=+l*k;this.M32=-c*k;this.M33=+d*k;this.M34=-n*k;this.M41=-t*k;this.M42=+a*k;this.M43=-v*k;this.M44=+m*k}};Atlantis.Matrix.invert=function(a){a=new Matrix(a);a.invert();return a};
Atlantis.Matrix.createWorld=function(a,b,c){var e=new Atlantis.Matrix;c=Atlantis.Vector3.cross(b,c);var d=Atlantis.Vector3.cross(c,b);Atlantis.Vector3.normalize(b);c.normalize();d.normalize();e.setTranslation(a);e.M44=1;return e};
Atlantis.Matrix.prototype.multiply=function(a){var b=this.M11*a.M12+this.M12*a.M22+this.M13*a.M32+this.M14*a.M42,c=this.M11*a.M13+this.M12*a.M23+this.M13*a.M33+this.M14*a.M43,e=this.M11*a.M14+this.M12*a.M24+this.M13*a.M34+this.M14*a.M44,d=this.M21*a.M11+this.M22*a.M21+this.M23*a.M31+this.M24*a.M41,g=this.M21*a.M12+this.M22*a.M22+this.M23*a.M32+this.M24*a.M42,f=this.M21*a.M13+this.M22*a.M23+this.M23*a.M33+this.M24*a.M43,h=this.M21*a.M14+this.M22*a.M24+this.M23*a.M34+this.M24*a.M44,l=this.M31*a.M11+
...
this.M12*a.M21+this.M13*a.M31+this.M14*a.M41;this.M12=b;this.M13=c;this.M14=e;this.M21=d;this.M22=g;this.M23=f;this.M24=h;this.M31=l;this.M32=t;this.M33=k;this.M34=m;this.M41=p;this.M42=n;this.M43=q;this.M44=r};Atlantis.Matrix.multiply=function(a,b,c){a=new Atlantis.Matrix(a);a.multiply(b);c instanceof Atlantis.Matrix&&a.multiply(c);return a};Atlantis.Matrix.prototype.subtract=function(a){var b=this.toArray();a=a.toArray();for(var c=0;16>c;c++)b[c]-=a[c];this.set(b)};
Atlantis.Matrix.subtract=function(a,b){var c=new Atlantis.Matrix(a);c.subtract(b);return c};Atlantis.Matrix.prototype.toString=function(){for(var a=this.toArray(),b=[],c=0;16>c;c+=4)b.push("["),b.push(a[c]+" "),b.push(a[c+1]+" "),b.push(a[c+2]+" "),b.push(a[c+3]),b.push("] ");return b.join("")};Atlantis=Atlantis||{};Atlantis.Quaternion=function(a,b,c,e){a instanceof Atlantis.Quaternion?(this.x=a.x,this.y=b.x,this.z=c.x,this.w=e.x):(this.x=a,this.y=b,this.z=c,this.w=e)};Atlantis.Quaternion.Identity=function(){return new Atlantis.Quaternion(0,0,0,1)};Atlantis.Quaternion.prototype.add=function(a){this.x+=a.x;this.y+=a.y;this.z+=a.z;this.w+=a.w};Atlantis.Quaternion.add=function(a,b){var c=new Quaternion(a);c.add(b);return c};
Atlantis.Quaternion.prototype.conjugate=function(){this.x*=-1;this.y*=-1;this.z*=-1};Atlantis.Quaternion.conjugate=function(a){a=new Quaternion(a);a.conjugate();return a};Atlantis.Quaternion.createFromYawPitchRoll=function(a,b,c){var e=new Quaternion;a*=0.5;var d=0.5*b;b=0.5*c;c=Math.sin(a);a=Math.cos(a);var g=Math.sin(d),d=Math.cos(d),f=Math.sin(b);b=Math.cos(b);e.x=a*g*b+c*d*f;e.y=c*d*b-a*g*f;e.z=a*d*f-c*g*b;e.w=a*d*b-c*g*f;return e};
Atlantis.Quaternion.prototype.toString=function(){return["x: ",this.x," y: ",this.y," z: ",this.z," w: ",this.w].join("")};Atlantis=Atlantis||{};Atlantis.Rectangle=function(a,b,c,e){a instanceof Atlantis.Rectangle?(this.x=a.x,this.y=a.y,this.width=a.width,this.height=a.height):(this.x=a||0,this.y=b||0,this.width=c||0,this.height=e||0)};Atlantis.Rectangle.prototype.add=function(a){this.x+=a.x;this.y+=a.y;this.width+=a.width;this.height+=a.height};Atlantis.Rectangle.prototype.divide=function(a){this.x/=a.x;this.y/=a.y;this.width/=a.width;this.height/=a.height};
...
Atlantis.Vector3.cross=function(a,b){var c=new Atlantis.Vector3;c.x=a.y*b.z-b.y*a.z;c.y=-(a.x*b.z-b.x*a.z);c.z=a.x*b.y-b.x*a.y;return c};Atlantis.Vector3.distance=function(a,b){return Math.sqrt(Atlantis.Vector3.distanceSquared(a,b))};Atlantis.Vector3.distanceSquared=function(a,b){var c=a.x-b.x,e=a.y-b.y,d=a.z-b.z;return c*c+e*e+d*d};Atlantis.Vector3.dot=function(a,b){return a.x*b.x+a.y*b.y+a.z*b.z};Atlantis.Vector3.prototype.length=function(){return Math.sqrt(this.x*this.x+this.y*this.y+this.z*this.z)};
Atlantis.Vector3.prototype.lerp=function(a,b){this.x=Atlantis.MathHelper.lerp(this.x,a.x,b);this.y=Atlantis.MathHelper.lerp(this.y,a.y,b);this.z=Atlantis.MathHelper.lerp(this.z,a.z,b)};Atlantis.Vector3.lerp=function(a,b){var c=Atlantis.MathHelper.lerp(a.x,b.x,amount),e=Atlantis.MathHelper.lerp(a.y,b.y,amount),d=Atlantis.MathHelper.lerp(a.z,b.z,amount);return new Atlantis.Vector3(c,e,d)};
...
Atlantis.Keyboard=function(a){this.keys=[];this.maxKeys=a||130;for(var b=0;b<a;b++)this.keys[b]=!1;this.preventDefault=!0;var c=this;a=function(a){c.preventDefault&&a.preventDefault();c.keys[a.keyCode]="keydown"===a.type?!0:!1};document.addEventListener("keydown",a,!1);document.addEventListener("keyup",a,!1)};Atlantis.Keyboard.prototype.getState=function(){return new Atlantis.KeyboardState(this.keys)};Atlantis=window.Atlantis||{};Atlantis.ButtonState={Released:0,Pressed:1};Atlantis.MouseState=function(a,b,c,e){this.x=a;this.y=b;this.scrollWheelValue=c;this.leftButton=e[0];this.rightButton=e[2];this.middleButton=e[1]};Atlantis.MouseState.prototype.clone=function(){return new Atlantis.MouseState(this.x,this.y,this.scrollWheelValue,[this.leftButton,this.middleButton,this.rightButton])};
Atlantis.Mouse=function(a){a=a instanceof HTMLElement?a:document.body;this._scroll=this._y=this._x=0;this._buttons=[];this._buttons[0]=!1;this._buttons[1]=!1;this._buttons[2]=!1;this.preventDefault=!0;var b=this,c=function(a){b.preventDefault&&a.preventDefault();b._x=a.offsetX||a.layerX;b._y=a.offsetY||a.layerY;b._buttons[0]=!1;b._buttons[1]=!1;b._buttons[2]=!1;b._buttons[a.button]="mousedown"===a.type?!0:!1;0<a.button&&"mousemove"===a.type&&(b._buttons[a.button]=!0)},e=function(a){b._scroll=Math.max(-1,
Math.min(1,a.wheelDelta||-a.detail))};a.addEventListener("mousedown",c,!1);a.addEventListener("mousemove",c,!1);a.addEventListener("mouseup",c,!1);a.addEventListener("click",c,!1);a.addEventListener("mousewheel",e,!1);a.addEventListener("DOMMouseScroll",e,!1)};Atlantis.Mouse.prototype.getState=function(){return new Atlantis.MouseState(this._x,this._y,this._scroll,this._buttons)};Atlantis=window.Atlantis||{};Atlantis.TouchLocationState={Invalid:1,Moved:2,Pressed:3,Released:4};Atlantis.TouchPanelState=function(a){this.state=a.touchState||Atlantis.TouchLocationState.Invalid;this.position=new Atlantis.Vector2(a.x||0,a.y||0)};Atlantis.TouchPanelState.prototype.clone=function(){return new Atlantis.TouchPanelState({state:this.state,position:{x:this.position.x,y:this.position.y}})};
...
a.removeEventListener("touchmove",this.updateHandler),a.removeEventListener("touchend",this.updateHandler),a.removeEventListener("touchcancel",this.updateHandler),b=!1)};this.initialize()};Atlantis=window.Atlantis||{};Atlantis.RenderTarget=function(a,b,c,e){this._canvas=e||document.createElement("canvas");this._context=null;this.viewport=new Atlantis.Rectangle(0,0,a,b);this._context=c?this._canvas.getContext("webgl")||this._canvas.getContext("experimental-webgl"):this._canvas.getContext("2d");this.isWebGLCanvas=function(){return c};this.setSize(a,b)};Atlantis.RenderTarget.prototype.setData=function(a){this._context.putImageData(a,0,0)};
...
Atlantis.SpriteBatch.drawTexture=function(a,b,c,e,d,g,f){f?a.drawImage(b,c,e,d,g,f.x,f.y,f.width,f.height):a.drawImage(b,c,e,d,g)};Atlantis.SpriteBatch.prototype.draw=function(a,b,c,e,d,g,f,h,l){this._batchStarted&&(b.width||(b.width=a.width,b.height=a.height),this._batchItems.push({type:Atlantis.BatchItemType.Texture,texture2D:a,sourceRectangle:c,destinationRectangle:b,color:e,rotation:d,origin:g,scale:f,effect:h?h:Atlantis.SpriteEffect.None,layerDepth:"number"===typeof l?l:0}))};
Atlantis.SpriteBatch.prototype.drawString=function(a,b,c,e,d,g,f,h,l){this._batchStarted&&this._batchItems.push({type:Atlantis.BatchItemType.Font,spriteFont:a,text:b,destinationRectangle:c,color:e,rotation:d,origin:g,scale:f,effect:h?h:Atlantis.SpriteEffect.None,layerDepth:"number"===typeof l?l:0})};
Atlantis.SpriteBatch.prototype._colorizeTexture=function(a,b){var c=this._searchColoredTexture(a,b);if(!c){c=document.createElement("canvas");c.width=a.width;c.height=a.height;var e=c.getContext("2d");e.drawImage(a,0,0);for(var d=e.getImageData(0,0,a.width,a.height),g=this._hexaToBytes(b),f=0,h=d.data.length;f<h;f+=4)d.data[f]|=g.r,d.data[f+1]|=g.g,d.data[f+2]|=g.b,d.data[f+3]|=g.a;e.putImageData(d,0,0);this._cacheColoredTextures.push({texture:a,color:b,canvas:c})}return c};
...
Atlantis.SpriteBatch.prototype._searchColoredTexture=function(a,b){for(var c=0,e=this._cacheColoredTextures.length,d=null;c<e&&null===d;)d=this._cacheColoredTextures[c].texture===a&&this._cacheColoredTextures[c].color===b?this._cacheColoredTextures[c].canvas:null,c++;return d};Atlantis=window.Atlantis||{};
Atlantis.Game=function(){function a(){c.gameTime.update();c.update(c.gameTime);c.draw(c.gameTime,c.context);requestAnimationFrame(a)}function b(a){c.width=a.target.innerWidth;c.height=a.target.innerHeight;c.canvas.width=c.width;c.canvas.height=c.height}var c=null,e=function(a,b,e,h){this.settings=h||{};this.settings.webGL=!1;a=a||window.innerWidth||640;b=b||window.innerHeight||480;this.domElement=e||document.body;this.gameTime=new Atlantis.GameTime;this.components=new Atlantis.GameComponentCollection;this.content=
new Atlantis.ContentManager;this.pointer=this.mouse=this.keyboard=null;this.graphicsDevice=new Atlantis.GraphicsDevice(a,b,this.settings);this.context=this.frontBuffer=null;this.initialized=this.isRunning=!1;c=this};e.prototype.initialize=function(){this.frontBuffer=this.graphicsDevice.getFrontBuffer();this.context=this.frontBuffer.getContext();this.keyboard=new Atlantis.Keyboard;this.mouse=new Atlantis.Mouse(this.frontBuffer.getCanvas());this.touchPanel=new Atlantis.TouchPanel(this.frontBuffer.getCanvas());
this.pointer=new Atlantis.PointerManager(this.frontBuffer.getCanvas());this.domElement.addEventListener("resize",b,!1);window.DeviceOrientationEvent&&window.addEventListener("orientationchange",b,!1);this.domElement&&!this.settings.canvas&&this.domElement.appendChild(this.frontBuffer.getCanvas());this.components.initialize()};e.prototype.loadContent=function(){this.components.loadContent(this.content)};e.prototype.unloadContent=function(){this.components.unloadContent()};e.prototype.update=function(a){this.components.update(a)};
e.prototype.draw=function(a,b){this.settings.autoClear&&this.graphicsDevice.clear();this.components.draw(a,b)};e.prototype.run=function(){this.initialized||(this.initialized=!0,this.initialize(),this.loadContent(),a())};return e}();
