...
Atlantis.Scene2D.prototype.remove=function(a){a instanceof Atlantis.Sprite||"number"===typeof a?Atlantis.SpriteGroup.prototype.remove.call(this,a):a instanceof Atlantis._tilemap&&(this._tilemap=null)};Atlantis.Scene2D.prototype.draw=function(a){this.camera.update();this.visible&&(Atlantis.SpriteGroup.prototype.draw.call(this,a),this._tilemap&&this._tilemap.draw(a,this.camera))};Atlantis=window.Atlantis||{};Atlantis.TilemapLayerType={Tiles:"tilelayer",Background:"imagelayer",Objects:"objectlayer"};Atlantis.TilemapProjection={Orthogonal:"orthogonal",Isometric:"isometric"};
