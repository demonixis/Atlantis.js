(function(){for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b,c){var f=(new Date).getTime(),g=Math.max(0,16-(f-a)),k=window.setTimeout(function(){b(f+g)},g);a=f+g;return k});window.cancelAnimationFrame||(window.cancelAnimationFrame=
...
Atlantis.Matrix.prototype.invert=function(){var a=this.M31*this.M42-this.M32*this.M41,b=this.M31*this.M43-this.M33*this.M41,c=this.M34*this.M41-this.M31*this.M44,d=this.M32*this.M43-this.M33*this.M42,e=this.M34*this.M42-this.M32*this.M44,f=this.M33*this.M44-this.M34*this.M43,g=this.M22*f+this.M23*e+this.M24*d,k=this.M21*f+this.M23*c+this.M24*b,m=this.M21*-e+this.M22*c+this.M24*a,q=this.M21*d+this.M22*-b+this.M23*a,h=this.M11*g-this.M12*k+this.M13*m-this.M14*q;if(0==Math.abs(h))this.set(this.getZeroValues());
else{var h=1/h,l=this.M11*this.M22-this.M12*this.M21,n=this.M11*this.M23-this.M13*this.M21,p=this.M14*this.M21-this.M11*this.M24,r=this.M12*this.M23-this.M13*this.M22,s=this.M14*this.M22-this.M12*this.M24,t=this.M13*this.M24-this.M14*this.M23,u=this.M12*f+this.M13*e+this.M14*d,f=this.M11*f+this.M13*c+this.M14*b,c=this.M11*-e+this.M12*c+this.M14*a,a=this.M11*d+this.M12*-b+this.M13*a,b=this.M42*t+this.M43*s+this.M44*r,d=this.M41*t+this.M43*p+this.M44*n,e=this.M41*-s+this.M42*p+this.M44*l,v=this.M41*
r+this.M42*-n+this.M43*l,w=this.M32*t+this.M33*s+this.M34*r,t=this.M31*t+this.M33*p+this.M34*n,p=this.M31*-s+this.M32*p+this.M34*l,l=this.M31*r+this.M32*-n+this.M33*l;this.M11=+g*h;this.M12=-u*h;this.M13=+b*h;this.M14=-w*h;this.M21=-k*h;this.M22=+f*h;this.M23=-d*h;this.M24=+t*h;this.M31=+m*h;this.M32=-c*h;this.M33=+e*h;this.M34=-p*h;this.M41=-q*h;this.M42=+a*h;this.M43=-v*h;this.M44=+l*h}};Atlantis.Matrix.invert=function(a){a=new Matrix(a);a.invert();return a};
...
Atlantis.SpriteBatch.prototype.draw=function(a,b,c,d,e,f,g,k,m){this._batchStarted&&(b.width||(b.width=a.width,b.height=a.height),this._batchItems.push({type:Atlantis.BatchItemType.Texture,texture2D:a,sourceRectangle:c,destinationRectangle:b,color:d,rotation:e,origin:f,scale:g,effect:k?k:Atlantis.SpriteEffect.None,layerDepth:"number"===typeof m?m:0}))};
Atlantis.SpriteBatch.prototype.drawString=function(a,b,c,d,e,f,g,k,m){this._batchStarted&&this._batchItems.push({type:Atlantis.BatchItemType.Font,spriteFont:a,text:b,destinationRectangle:{x:c.x,y:c.y,width:1,height:1},color:d,rotation:e,origin:f,scale:g,effect:k?k:Atlantis.SpriteEffect.None,layerDepth:"number"===typeof m?m:0})};
Atlantis.SpriteBatch.prototype._colorizeTexture=function(a,b){var c=this._searchColoredTexture(a,b);if(!c){c=document.createElement("canvas");c.width=a.width;c.height=a.height;var d=c.getContext("2d");d.drawImage(a,0,0);for(var e=d.getImageData(0,0,a.width,a.height),f=this._hexaToBytes(b),g=0,k=e.data.length;g<k;g+=4)e.data[g]|=f.r,e.data[g+1]|=f.g,e.data[g+2]|=f.b,e.data[g+3]|=f.a;d.putImageData(e,0,0);this._cacheColoredTextures.push({texture:a,color:b,canvas:c})}return c};
...
Atlantis.Game=function(){function a(){c.gameTime.update();c.update(c.gameTime);c.draw(c.gameTime);c.beforeDraw(c.gamepad);c._paused||requestAnimationFrame(a)}function b(a){c.width=a.target.innerWidth;c.height=a.target.innerHeight;c.canvas.width=c.width;c.canvas.height=c.height}var c=null,d=function(a,b,d,k){this.settings=k||{};this.settings.webGL=!1;a=a||window.innerWidth||640;b=b||window.innerHeight||480;this.domElement=document.body;typeof d instanceof HTMLElement?this.domElement=d:"string"===typeof d&&
...
Atlantis.Camera2D.prototype.getSpritePosition=function(){return this._follow?{x:this._follow.rectangle.x+this.x,y:this._follow.rectangle.y+this.y}:{x:this.x,y:this.y}};
...
Atlantis.Sprite.prototype.getHeight=function(){return this.rectangle.height};Atlantis.Sprite.prototype.setDirection=function(a){this.direction.x=x;this.direction.y=y};Atlantis.Sprite.prototype.getDirection=function(){return this.direction};Atlantis.Sprite.prototype.getName=function(){return this.name};Atlantis.Sprite.prototype.setName=function(a){this.name=a};Atlantis.Sprite.prototype.getBoundingRect=function(){return this.rectangle};Atlantis=window.Atlantis||{};Atlantis.SpriteGroup=function(){Atlantis.Sprite.call(this);this.entities=[]};Atlantis.SpriteGroup.prototype=Object.create(Atlantis.Sprite.prototype);Atlantis.SpriteGroup.prototype.initialize=function(){for(var a=0,b=this.entities.length;a<b;a++)this.entities[a].initialize()};Atlantis.SpriteGroup.prototype.loadContent=function(a){for(var b=0,c=this.entities.length;b<c;b++)this.entities[b].loadContent(a)};
Atlantis.SpriteGroup.prototype.update=function(a){if(this.enabled)for(var b=0,c=this.entities.length;b<c;b++)this.entities[b].enabled&&this.entities[b].update(a)};Atlantis.SpriteGroup.prototype.draw=function(a){if(this.visible)for(var b=0,c=this.entities.length;b<c;b++)this.entities[b].visible&&this.entities[b].draw(a)};Atlantis.SpriteGroup.prototype.add=function(a){if(a instanceof Array)for(var b=0,c=a.length;b<c;b++)this.entities.push(a[b]);else this.entities.push(a)};
Atlantis.SpriteGroup.prototype.remove=function(a){var b=null;if(a instanceof Atlantis.Entity){var c=this.entities.indexOf(a);-1<c&&(b=this.entities[c],this.entities.splice(c,1))}else-1<a&&(b=this.entities[c],this.entities.splice(c,1));return b};Atlantis.SpriteGroup.prototype.get=function(a){var b=null;-1<a&&(b=this.entities[a]);return b};Atlantis.SpriteGroup.prototype.clear=function(){this.entities.length=0};Atlantis=window.Atlantis||{};Atlantis.TilemapLayerType={Tiles:"tilelayer",Background:"imagelayer",Objects:"objectlayer"};Atlantis.TilemapProjection={Orthogonal:"orthogonal",Isometric:"isometric"};
...
Atlantis.TilemapLayer=function(a){a=a||{};this.id=Atlantis.TilemapLayer.Counter++;this.data=a.data||[];this.type=a.type||Atlantis.TilemapLayer.Tiles;this.visible=a.visible;this.opacity=+a.opacity;this.name=a.name||["Layer_",this.id].join("");this.width=+a.width|0;this.height=+a.height|0;this.offset={x:+a.x|0,y:+a.y|0};this.properties=a.properties||{};this.backgroundId=+a.backgroundId||this.properties.backgroundId||0;this.tilesetId=+a.tilesetId||this.properties.tilesetId||0;this.isCollider=this.properties.Collider||
a.isCollider};Atlantis.TilemapLayer.Counter=0;Atlantis.TilemapLayer.prototype.drawBackground=function(a,b){a.draw(b,{x:this.offset.x,y:this.offset.y})};
Atlantis.TilemapLayer.prototype.drawTiles=function(a,b,c,d){var e=c.width/c.tileWidth,f=b.x/d.width,g=b.y/d.height,k=Math.floor(f),m=Math.floor(g),q=Math.min(Math.round((b.x+Atlantis.screen.width)/c.tileWidth)+1,this.width);b=Math.min(Math.round((b.y+Atlantis.screen.height)/c.tileHeight)+1,this.height);for(var h=0,l=0,l=0;k<q;k++)for(var n=m;n<b;n++)l=this.data[k+n*this.width]-c.firstGID,0<=l&&(h=l%e,l=Math.floor(l/e),h=0<l?h%(e*l):h%e,a.draw(c.texture,{x:(k+this.offset.x-f)*d.width,y:(n+this.offset.y-
g)*d.height,width:d.width,height:d.height},{x:h*c.tileWidth,y:l*c.tileHeight,width:c.tileWidth,height:c.tileHeight}))};
Atlantis.Tilemap=function(a){a=a||{};this.id=Atlantis.Tilemap.Counter++;this.version=+a.version|0;this.layers=a.layers||[];this.tilesets=a.tilesets||[];this.backgrounds=a.backgrounds||[];this.width=+a.width|0;this.height=+a.height|0;this.name=a.name||["Tilemap_",this.id].join("");this.projection=a.orientation||a.projection||Atlantis.TilemapProjection.Orthogonal;this.properties=a.properties||{};this.tileSize={width:+a.tilewidth|0,height:+a.tileheight|0};this.mapWidth=this.width*this.tileSize.width;
this.mapHeight=this.height*this.tileSize.height;this.loaded="undefined"!==typeof a.loaded?a.loaded:!1;this.visible="undefined"!==typeof a.visible?a.visible:!0;this._cacheTilesCanvas=[]};Atlantis.Tilemap.Counter=0;
Atlantis.Tilemap.prototype.draw=function(a,b){if(this.visible&&this.loaded)for(var c=0,d=this.layers.length;c<d;c++)this.layers[c].visible&&(this.layers[c].type===Atlantis.TilemapLayerType.Background?this.layers[c].drawBackground(a,this.backgrounds[this.layers[c].backgroundId]):this.layers[c].type===Atlantis.TilemapLayerType.Tiles&&this.layers[c].drawTiles(a,b,this.tilesets[this.layers[c].tilesetId],this.tileSize))};
Atlantis.Tilemap.prototype.getTileIdAt=function(a,b,c){return this.layers[a]?(a=this.layers[a],b=Math.floor(b/this.tileSize.width),c=Math.floor(c/this.tileSize.height),a.data[b+c*a.width]):0};
Atlantis.Tilemap.prototype.getTileAt=function(a,b,c,d){if(this.layers[b]){var e=this.layers[b];b=this.getTileIdAt(b,c,d);e=[e.id,"_",a.id,"_",b].join("");if(this._cacheTilesCanvas[e])return this._cacheTilesCanvas[e];c=document.createElement("canvas");d=c.getContext("2d");c.width=a.tileWidth;c.height=a.tileHeight;if(0<=b){var f=a.imagewidth/a.tilewidth,g=b%f;b=Math.floor(b/f);d.drawImage(a.texture,{x:(0<b?g%(f*b):g%f)*a.tileWidth,y:b*a.tileHeight,width:a.tileWidth,height:a.tileHeight},{x:0,y:0,width:this.tileSize.width,
height:this.tileSize.height});return this._cacheTilesCanvas[e]=c}}return null};Atlantis=window.Atlantis||{};
...
f);d.height=b.height;d.width=b.width;d.tileSize.width=b.tilewidth;d.tileSize.height=b.tileheight;d.mapWidth=d.width*d.tileSize.width;d.mapHeight=d.height*d.tileSize.height;d.version=b.version;d.properties=b.properties;d.visible=!0;d.loaded=!0;c&&c(d)});return d}};
