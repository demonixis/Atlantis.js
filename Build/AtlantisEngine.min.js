...
Atlantis.ContentManager=function(){function a(a,b,c){var d=new Image;d.onload=function(){this.style.position="absolute";this.style.left="-9999px";document.body.appendChild(d);document.body.removeChild(d);this.style.position="";this.style.left="";c(this)};d.src=b;return a[b]=d}function b(a,b,c){var d=document.createElement("audio");d.onload=c;d.src=b;d.controls=!1;return a[b]=d}function c(a,b,c){var d=document.createElement("video");d.onload=c;d.src=b;return a[b]=d}function d(a,b,c,d){Atlantis.ajax({method:"GET",
url:b,success:function(e){var k=e;"json"==c&&(k=JSON.parse(e));a[b]=k;d(a[b])}})}var e=function(a){this.rootDirectory=a||"";this.assets=[]};e.prototype.load=function(e,f){f="function"===typeof f?f:function(){};if(this.assets[e])f(this.assets[e]);else{var h=e.split("."),h=h[h.length-1];e=this.rootDirectory+e;switch(h){case "png":case "jpg":case "bmp":a(this.assets,e,f);break;case "mp3":case "ogg":case "wav":b(this.assets,e,f);break;case "mp4":case "ogv":c(this.assets,e,f);case "xml":case "json":case "js":d(this.assets,
e,h,f)}}return this.assets[e]};e.prototype.setRootDirectory=function(a){this.rootDirectory=a};e.prototype.getRootDirectory=function(){return this.rootDirectory};e.prototype.dispose=function(){this.assets.length=0};return e}();Atlantis=window.Atlantis||{};Atlantis.GameComponent=function(a){this.game=a;this.enabled=!0;this.initialized=!1};Atlantis.GameComponent.prototype.initialize=function(){this.initialized=!0};Atlantis.GameComponent.prototype.update=function(a){};Atlantis.GameComponent.prototype.isEnabled=function(){return this.enabled};Atlantis.GameComponent.prototype.isInitialized=function(){return this.initialized};Atlantis.GameComponent.prototype.setEnabled=function(a){this.enabled=a};
...
Atlantis.GameTime.prototype.getTotalGameTime=function(){return this.totalGameTime};Atlantis.GameTime.prototype.getFPS=function(){return this.fps};Atlantis=window.Atlantis||{};
...
Atlantis.notify=function(a,b){var c=document.createEvent("HTMLEvents");c.initEvent(a,!0,!1);if(b instanceof Object)for(var d in b)c[d]=b[d];document.dispatchEvent(c)};Atlantis=window.Atlantis||{};Atlantis.MathHelper={Pi:function(){return Math.PI},PiOver2:function(){return Math.PI/2},PiOver4:function(){return Math.PI/4},TwoPi:function(){return 2*Math.PI},clamp:function(a,b,c){a=a>c?c:a;return a<b?b:a},distance:function(a,b){return Math.abs(a-b)},lerp:function(a,b,c){c=0>c?0:c;return a+(b-a)*(1<c?1:c)},toDegrees:function(a){return 180/Math.PI*a},toRadians:function(a){return Math.PI/180*a},isPowerOfTwo:function(a){return 0<a&&0==(a&a-1)}};Atlantis=window.Atlantis||{};Atlantis.Matrix=function(a){a instanceof Atlantis.Matrix?(a=a.toArray(),this.set(a)):a instanceof Array&&16==a.length?this.set(a):this.M44=this.M43=this.M42=this.M41=this.M34=this.M33=this.M32=this.M31=this.M24=this.M23=this.M22=this.M21=this.M14=this.M13=this.M12=this.M11=0};
...
Atlantis.Matrix.createPerspectiveOffCenter=function(a,b,c,d,e,g){g/=g-e;var f=new Atlantis.Matrix;f.M11=2*e/(b-a);f.M22=2*e/(d-c);f.M31=(a+b)/(a-b);f.M32=(d+c)/(c-d);f.M33=g;f.M34=1;f.M43=-e*g;return f};Atlantis.Matrix.createPerspectiveOffCenterRH=function(a,b,c,d,e,g){a=createPerspectiveOffCenter(a,b,c,d,e,g);a.M31*=-1;a.M32*=-1;a.M33*=-1;a.M34*=-1;return a};
Atlantis.Matrix.prototype.invert=function(){var a=this.M31*this.M42-this.M32*this.M41,b=this.M31*this.M43-this.M33*this.M41,c=this.M34*this.M41-this.M31*this.M44,d=this.M32*this.M43-this.M33*this.M42,e=this.M34*this.M42-this.M32*this.M44,g=this.M33*this.M44-this.M34*this.M43,f=this.M22*g+this.M23*e+this.M24*d,h=this.M21*g+this.M23*c+this.M24*b,l=this.M21*-e+this.M22*c+this.M24*a,t=this.M21*d+this.M22*-b+this.M23*a,k=this.M11*f-this.M12*h+this.M13*l-this.M14*t;if(0==Math.abs(k))this.set(this.getZeroValues());
else{var k=1/k,m=this.M11*this.M22-this.M12*this.M21,p=this.M11*this.M23-this.M13*this.M21,n=this.M14*this.M21-this.M11*this.M24,q=this.M12*this.M23-this.M13*this.M22,r=this.M14*this.M22-this.M12*this.M24,s=this.M13*this.M24-this.M14*this.M23,u=this.M12*g+this.M13*e+this.M14*d,g=this.M11*g+this.M13*c+this.M14*b,c=this.M11*-e+this.M12*c+this.M14*a,a=this.M11*d+this.M12*-b+this.M13*a,b=this.M42*s+this.M43*r+this.M44*q,d=this.M41*s+this.M43*n+this.M44*p,e=this.M41*-r+this.M42*n+this.M44*m,v=this.M41*
q+this.M42*-p+this.M43*m,w=this.M32*s+this.M33*r+this.M34*q,s=this.M31*s+this.M33*n+this.M34*p,n=this.M31*-r+this.M32*n+this.M34*m,m=this.M31*q+this.M32*-p+this.M33*m;this.M11=+f*k;this.M12=-u*k;this.M13=+b*k;this.M14=-w*k;this.M21=-h*k;this.M22=+g*k;this.M23=-d*k;this.M24=+s*k;this.M31=+l*k;this.M32=-c*k;this.M33=+e*k;this.M34=-n*k;this.M41=-t*k;this.M42=+a*k;this.M43=-v*k;this.M44=+m*k}};Atlantis.Matrix.invert=function(a){a=new Matrix(a);a.invert();return a};
...
Atlantis.Keyboard=function(a){this.keys=[];this.maxKeys=a||130;for(var b=0;b<a;b++)this.keys[b]=!1;this.preventDefault=!0;var c=this;a=function(a){c.preventDefault&&a.preventDefault();c.keys[a.keyCode]="keydown"===a.type?!0:!1};document.addEventListener("keydown",a,!1);document.addEventListener("keyup",a,!1)};Atlantis.Keyboard.prototype.getState=function(){return new Atlantis.KeyboardState(this.keys)};Atlantis=window.Atlantis||{};Atlantis.ButtonState={Released:0,Pressed:1};Atlantis.MouseState=function(a,b,c,d){this.x=a;this.y=b;this.scrollWheelValue=c;this.leftButton=d[0];this.rightButton=d[2];this.middleButton=d[1]};Atlantis.MouseState.prototype.clone=function(){return new Atlantis.MouseState(this.x,this.y,this.scrollWheelValue,[this.leftButton,this.middleButton,this.rightButton])};
...
Atlantis.TouchPanel=function(a){this._states=[];var b=this,c=function(a){var c=a.touches.length;b._states.length=c;for(var g=0;g<c;g++)b._states[g]={x:a.touches[g].clientX,y:a.touches[g].clientY},b._states[g].touchState="touchstart"==a.type?Atlantis.TouchLocationState.Pressed:"touchmove"==a.type?Atlantis.TouchLocationState.Moved:"touchend"==a.type?Atlantis.TouchLocationState.Released:Atlantis.TouchLocationState.Invalid};a.addEventListener("touchstart",c,!1);a.addEventListener("touchmove",c,!1);a.addEventListener("touchend",
c,!1);a.addEventListener("touchcancel",c,!1)};Atlantis.TouchPanel.prototype.getCapabilities=function(){};Atlantis.TouchPanel.prototype.getState=function(a){if(a)return new Atlantis.TouchPanelState(this._states[0]?this._states[0]:{});a=[];for(var b=0,c=this._states.length;b<c;b++)a.push(new Atlantis.TouchPanelState(this._states[b]));return a};Atlantis=window.Atlantis||{};
Atlantis.PointerManager=function(a){this.y=this.x=0;this.previousState={x:0,y:0};this.delta={x:0,y:0};this.click=!1;this.release=!0;this.drag=!1;this.hasTouch=!!("ontouchstart"in window)||!!("onmsgesturechange"in window);this.touch=!1;a=a||document.body;var b=!1;this.initialize=function(){b||(a.addEventListener("mousedown",this.updateHandler,!1),a.addEventListener("mousemove",this.updateHandler,!1),a.addEventListener("mouseup",this.updateHandler,!1),a.addEventListener("click",this.updateHandler,!1),
a.addEventListener("touchstart",this.updateHandler,!1),a.addEventListener("touchmove",this.updateHandler,!1),a.addEventListener("touchend",this.updateHandler,!1),a.addEventListener("touchcancel",this.updateHandler,!1),b=!0)};this.dispose=function(){b&&(a.removeEventListener("mousedown",this.updateHandler),a.removeEventListener("mousemove",this.updateHandler),a.removeEventListener("mouseup",this.updateHandler),a.removeEventListener("click",this.updateHandler),a.removeEventListener("touchstart",this.updateHandler),
a.removeEventListener("touchmove",this.updateHandler),a.removeEventListener("touchend",this.updateHandler),a.removeEventListener("touchcancel",this.updateHandler),b=!1)};this.initialize()};Atlantis=window.Atlantis||{};Atlantis.RenderTarget=function(a,b,c,d){this._canvas=d||document.createElement("canvas");this._context=null;this.viewport=new Atlantis.Rectangle(0,0,a,b);this._context=c?this._canvas.getContext("webgl")||this._canvas.getContext("experimental-webgl"):this._canvas.getContext("2d");this.isWebGLCanvas=function(){return c};this.setSize(a,b)};Atlantis.RenderTarget.prototype.setData=function(a){this._context.putImageData(a,0,0)};
Atlantis.RenderTarget.prototype.getData=function(){return this._context.getImageData(0,0,this.viewport.width,this.viewport.height)};Atlantis.RenderTarget.prototype.getContext=function(){return this._context};Atlantis.RenderTarget.prototype.getCanvas=function(){return this._canvas};Atlantis.RenderTarget.prototype.getWidth=function(){return this.viewport.width};Atlantis.RenderTarget.prototype.getHeight=function(){return this.viewport.height};
Atlantis.RenderTarget.prototype.setSize=function(a,b){this._canvas.width=a;this._canvas.height=b;this.viewport.setSize(a,b)};Atlantis.RenderTarget.prototype.getViewport=function(){return this.viewport};
Atlantis.RenderTarget.prototype.clear=function(a){this._is3DCanvas?(this._context.clearColor(a.r,a.g,a.b,a.a),this._context.enable(this._context.DEPTH_TEST),this._context.depthFunc(this._context.LEQUAL),this._context.clear(this._context.COLOR_BUFFER_BIT|this._context.DEPTH_BUFFER_BIT)):this._context.clearRect(0,0,this._canvas.width,this._canvas.height)};Atlantis.RenderTarget.prototype.saveAsPng=function(){return this._canvas.toDataURL("image/png")};Atlantis.RenderTarget.prototype.saveAsJpg=function(){return this._canvas.toDataURL("image/jpg")};Atlantis=window.Atlantis||{};
Atlantis.GraphicsDevice=function(a,b,c){c=c||{};c.webGL?!0:!1;c.width=a;c.height=b;this.preferredBackBufferWidth=c.backBufferWidth||a;this.preferredBackBufferHeight=c.backBufferWidth||b;a&&b&&(this._frontBuffer=new Atlantis.RenderTarget(a,b,c.webGL,c.canvas),this._fbContext=this._frontBuffer.getContext(),this._backBuffer=new Atlantis.RenderTarget(this.preferredBackBufferWidth,this.preferredBackBufferHeight,c.webGL),a=this._frontBuffer.getCanvas(),a.style.msTouchAction="none",a.style.backgroundColor=
"#000",a.id=a.id?a.id:"AtlantisCanvas")};Atlantis.GraphicsDevice.prototype.applyChanges=function(){this._backBuffer.setSize(this.preferredBackBufferWidth,this.preferredBackBufferHeight)};Atlantis.GraphicsDevice.prototype.getBackBuffer=function(){return this._backBuffer};Atlantis.GraphicsDevice.prototype.getFrontBuffer=function(){return this._frontBuffer};Atlantis.GraphicsDevice.prototype.clear=function(a){this._backBuffer.clear(a);this._frontBuffer.clear(a)};
Atlantis.GraphicsDevice.prototype.present=function(){this._fbContext.drawImage(this._backBuffer.getCanvas(),this._frontBuffer.viewport.x,this._frontBuffer.viewport.y,this._frontBuffer.viewport.width,this._frontBuffer.viewport.height)};
...
Atlantis.GraphicsDevice.prototype.isFullscreen=function(){return document.webkitIsFullScreen||document.mozFullScreen||document.msFullscreenElement||!1};Atlantis=window.Atlantis||{};Atlantis.SpriteFont=function(a,b,c){this.fontName=a||"Arial";this.size=b||14;this.style=c||"normal"};Atlantis.SpriteFont.prototype.getFont=function(){return[this.style," ",this.size,"px ",this.fontName].join("")};Atlantis.Texture2D=function(a,b){this.textureData=[]};Atlantis=window.Atlantis||{};Atlantis.SpriteSortMode={BackToFront:0,FrontToBack:1,Immediate:2};Atlantis.SpriteEffect={None:0,FlipHorizontaly:1,FlipVerticaly:2};Atlantis.BatchItemType={Texture:0,Font:1};
Atlantis.SpriteBatch=function(a){this._graphicsDevice=a;this._renderTarget=new Atlantis.RenderTarget(a.preferredBackBufferWidth,a.preferredBackBufferHeight,!1);this._canvas=this._renderTarget.getCanvas();this._context=this._renderTarget.getContext();this._batchItems=[];this._batchStarted=!1;this._spriteSortMode=Atlantis.SpriteSortMode.Immediate;this._transformMatrix=null;this._cacheColoredTextures=[]};
Atlantis.SpriteBatch.prototype.begin=function(a,b){this._batchStarted||(this._batchStarted=!0,this._transformMatrix=b?6===b.length?b:null:null,this._spriteSortMode="number"===typeof a?a:Atlantis.SpriteSortMode.Immediate,this._renderTarget.clear())};
Atlantis.SpriteBatch.prototype.end=function(){if(this._batchStarted){var a={},b=this;this._spriteSortMode!==Atlantis.SpriteSortMode.Immediate&&(this._batchItems=this._batchItems.sort(function(a,c){return b._spriteSortMode===Atlantis.SpriteSortMode.BackToFront?a.layerDepth>c.layerDepth:a.layerDepth<c.layerDepth}));var c,d,e,g;this._transformMatrix&&(this._context.save(),this._context.transform(this._transformMatrix[0],this._transformMatrix[1],this._transformMatrix[2],this._transformMatrix[3],this._transformMatrix[4],
this._transformMatrix[5]));for(var f=0,h=this._batchItems.length;f<h;f++)a=this._batchItems[f],c=a.destinationRectangle.x,d=a.destinationRectangle.y,e=a.destinationRectangle.width,g=a.destinationRectangle.height,c=a.origin?a.origin.x:0,d=a.origin?a.origin.y:0,this._context.save(),this._context.translate(a.destinationRectangle.x,a.destinationRectangle.y),this._context.translate(c,d),c=-c,d=-d,a.rotation&&this._context.rotate(a.rotation),a.scale&&this._context.scale(a.scale.x,a.scale.y),a.effect!=Atlantis.SpriteEffect.None&&
(a.effect==Atlantis.SpriteEffect.FlipHorizontaly?(this._context.scale(-1,1),c-=a.destinationRectangle.width):(this._context.scale(1,-1),d-=a.destinationRectangle.height)),a.type===Atlantis.BatchItemType.Texture?a.color&&a.texture2D.width&&a.texture2D.height?Atlantis.SpriteBatch.drawTexture(this._context,this._colorizeTexture(a.texture2D,a.color),c,d,e,g,a.sourceRectangle):Atlantis.SpriteBatch.drawTexture(this._context,a.texture2D,c,d,e,g,a.sourceRectangle):a.type===Atlantis.BatchItemType.Font&&(this._context.fillStyle=
a.color,this._context.font=a.spriteFont.getFont(),this._context.fillText(a.text,c,d)),this._context.restore();this._transformMatrix&&this._context.restore();this._graphicsDevice.getBackBuffer().getContext().drawImage(this._canvas,this._renderTarget.viewport.x,this._renderTarget.viewport.y,this._renderTarget.viewport.width,this._renderTarget.viewport.height);this._graphicsDevice.present();this._batchItems.length=0;this._batchStarted=!1}};
Atlantis.SpriteBatch.drawTexture=function(a,b,c,d,e,g,f){f?a.drawImage(b,c,d,e,g,f.x,f.y,f.width,f.height):a.drawImage(b,c,d,e,g)};Atlantis.SpriteBatch.prototype.draw=function(a,b,c,d,e,g,f,h,l){this._batchStarted&&(b.width||(b.width=a.width,b.height=a.height),this._batchItems.push({type:Atlantis.BatchItemType.Texture,texture2D:a,sourceRectangle:c,destinationRectangle:b,color:d,rotation:e,origin:g,scale:f,effect:h?h:Atlantis.SpriteEffect.None,layerDepth:"number"===typeof l?l:0}))};
Atlantis.SpriteBatch.prototype.drawString=function(a,b,c,d,e,g,f,h,l){this._batchStarted&&this._batchItems.push({type:Atlantis.BatchItemType.Font,spriteFont:a,text:b,destinationRectangle:c,color:d,rotation:e,origin:g,scale:f,effect:h?h:Atlantis.SpriteEffect.None,layerDepth:"number"===typeof l?l:0})};
Atlantis.SpriteBatch.prototype._colorizeTexture=function(a,b){var c=this._searchColoredTexture(a,b);if(!c){c=document.createElement("canvas");c.width=a.width;c.height=a.height;var d=c.getContext("2d");d.drawImage(a,0,0);for(var e=d.getImageData(0,0,a.width,a.height),g=this._hexaToBytes(b),f=0,h=e.data.length;f<h;f+=4)e.data[f]|=g.r,e.data[f+1]|=g.g,e.data[f+2]|=g.b,e.data[f+3]|=g.a;d.putImageData(e,0,0);this._cacheColoredTextures.push({texture:a,color:b,canvas:c})}return c};
...
Atlantis.Game=function(){function a(){c.gameTime.update();c.update(c.gameTime);c.draw(c.gameTime,c.context);requestAnimationFrame(a)}function b(a){c.width=a.target.innerWidth;c.height=a.target.innerHeight;c.canvas.width=c.width;c.canvas.height=c.height}var c=null,d=function(a,b,d,h){this.settings=h||{};this.settings.webGL=!1;a=a||window.innerWidth||640;b=b||window.innerHeight||480;this.domElement=d||document.body;this.gameTime=new Atlantis.GameTime;this.components=new Atlantis.GameComponentCollection;this.content=
new Atlantis.ContentManager;this.pointer=this.mouse=this.keyboard=null;this.graphicsDevice=new Atlantis.GraphicsDevice(a,b,this.settings);this.context=this.frontBuffer=null;this.initialized=this.isRunning=!1;c=this};d.prototype.initialize=function(){this.frontBuffer=this.graphicsDevice.getFrontBuffer();this.context=this.frontBuffer.getContext();this.keyboard=new Atlantis.Keyboard;this.mouse=new Atlantis.Mouse(this.frontBuffer.getCanvas());this.touchPanel=new Atlantis.TouchPanel(this.frontBuffer.getCanvas());
this.pointer=new Atlantis.PointerManager(this.frontBuffer.getCanvas());this.domElement.addEventListener("resize",b,!1);window.DeviceOrientationEvent&&window.addEventListener("orientationchange",b,!1);this.domElement&&!this.settings.canvas&&this.domElement.appendChild(this.frontBuffer.getCanvas());this.components.initialize()};d.prototype.loadContent=function(){this.components.loadContent(this.content)};d.prototype.unloadContent=function(){this.components.unloadContent()};d.prototype.update=function(a){this.components.update(a)};
d.prototype.draw=function(a,b){this.settings.autoClear&&this.graphicsDevice.clear();this.components.draw(a,b)};d.prototype.run=function(){this.initialized||(this.initialized=!0,this.initialize(),this.loadContent(),a())};return d}();Atlantis=window.Atlantis||{};Atlantis.MusicState={};
Atlantis.AudioManager=function(){Atlantis.MusicState.PLAYING=1;Atlantis.MusicState.STOPPED=2;Atlantis.MusicState.PAUSED=3;var a=function(){this.repeatMusic=!1;this.currentMusic=null;this.volume=1;this.currentState=Atlantis.MusicState.STOPPED};a.prototype.playMusic=function(a,c){this.stopMusic();this.currentMusic=a;this.repeat=c;this.currentMusic.play();this.currentState=Atlantis.MusicState.PLAYING};a.prototype.stopMusic=function(){this.currentState=Atlantis.MusicState.STOPPED};a.prototype.pauseMusic=
function(){null!=this.currentMusic&&this.currentState==Atlantis.MusicState.PLAYING&&(this.currentMusic.pause(),this.currentState=Atlantis.MusicState.PAUSED)};return a}();Atlantis=window.Atlantis||{};
Atlantis.State=function(){var a=function(a){this.name=a;this.active=!0;this.stateManager=null;this.assetLoaded=this.initialized=!1;this.visible=this.enabled=!0;this.scene=new Atlantis.SpriteGroup};a.prototype.isActive=function(){return this.visible&&this.enabled};a.prototype.isEnabled=function(){return this.enabled};a.prototype.isVisible=function(){return this.visible};a.prototype.setActive=function(a){this.visible=this.enabled=a};a.prototype.initialize=function(){this.scene.initialize();this.initialized=
!0};a.prototype.loadContent=function(a){this.scene.loadContent(a);this.assetLoaded=!0};a.prototype.update=function(a){this.scene.update(a)};a.prototype.draw=function(a,c){this.scene.draw(a,c)};a.prototype.add=function(a){this.scene.add(a)};a.prototype.remove=function(a){this.scene.remove(a)};a.prototype.get=function(a){return this.scene.get(a)};return a}();
Atlantis.StateManager=function(){var a=function(a){Atlantis.DrawableGameComponent.call(this,a);this.states=[];this.assetLoaded=this.initialized=!1};a.prototype=new Atlantis.DrawableGameComponent;a.prototype.initialize=function(){for(var a=0,c=this.states.length;a<c;a++)this.states[a].initialize();this.initialized=!0};a.prototype.loadContent=function(){for(var a=0,c=this.states.length;a<c;a++)this.states[a].loadContent(this.game.content);this.assetLoaded=!0};a.prototype.update=function(a){for(var c=
0,d=this.states.length;c<d;c++)this.states[c].isEnabled()&&this.states[c].update(a)};a.prototype.draw=function(a,c){for(var d=0,e=this.states.length;d<e;d++)this.states[d].isVisible()&&this.states[d].draw(a,c)};a.prototype.setActive=function(a,c){c&&this.disableStates();if(a instanceof Atlantis.State){var d=this.states.indexOf(a);-1<d&&this.states[d].setActive(!0)}else if("string"==typeof a)for(var e=0,d=-1,g=this.states.length;e<g&&-1==d;)this.states[e].name==a&&(this.states[e].setActive(!0),d=e),
e++;else-1<a&&a<this.states.length&&(this.states[a].active=!0)};a.prototype.loadLevel=function(a){var c=this.states.length,d=c-1;this.disableStates();if("string"==typeof a)for(var e=0;e<c;e++){if(this.states[e].name==a){d=e;break}}else"number"===typeof a&&(d=a<c?a:d);-1<d&&(this.states[d].active=!0)};a.prototype.disableStates=function(){for(var a=0,c=this.states.length;a<c;a++)this.states[a].setActive(!1)};a.prototype.add=function(a,c,d){d&&this.disableStates();a.stateManager=this;a.setActive("undefined"!=
typeof c?c:!0);this.initialized&&(a[i].initialize(),a[i].loadContent(this.game.content));this.states.push(a)};a.prototype.remove=function(a){var c=null;if("string"==typeof a){for(var d=0,e=-1;d<size&&-1==e;)this.states[d].name==a&&(e=d),d++;-1<e&&(c=this.states[e],this.states.splice(e,1))}else-1<a&&(c=this.states[a],this.states.splice(e,1));return c};a.prototype.get=function(a){var c=null;if("string"==typeof a){for(var d=0,e=-1;d<size&&-1==e;)this.states[d].name==a&&(e=d),d++;-1<e&&(c=this.states[e])}else-1<
c&&(c=this.states[a]);return c};return a}();Atlantis=window.Atlantis||{};Atlantis.StorageManager=function(){function a(a,b){return(b||"Atlantis.Engine")+"."+a}var b=function(){};b.prototype.save=function(b,d,e){"object"==typeof e&&(e=JSON.stringify(e));localStorage.setItem(a(d,b),e)};b.prototype.load=function(b,d,e){b=localStorage.getItem(a(d,b));return null!=b&&e?JSON.parse(b):b};return b}();Atlantis=window.Atlantis||{};
Atlantis.Interpolator=function(){var a=function(){this.active=!1;this.interpolatedValue=this.endValue=this.startValue=this.desiredDuration=this.elapsedTime=0};a.prototype.startInterpolation=function(a,c,d){this.startValue=a;this.endValue=c;this.desiredDuration=d;this.elapsedTime=0;this.interpolatedValue=a;this.active=!0};a.prototype.getInterpolatedValue=function(a){this.active&&(this.elapsedTime+=a,this.elapsedTime>=this.desiredDuration?(this.active=!1,this.elapsedTime=this.desiredDuration,this.interpolatedValue=
this.endValue):this.interpolateValue(this.elapsedTime/this.desiredDuration));return this.interpolatedValue};a.prototype.interpolateValue=function(a){this.interpolatedValue=Atlantis.MathHelper.lerp(this.startValue,this.endValue,a)};return a}();Atlantis=window.Atlantis||{};
Atlantis.KeyboardComponent=function(){var a=Atlantis.Keys,b=function(a){Atlantis.GameComponent.call(this,a);this.keysState=a.keyboard.getState();this.previousKeysState=null};b.prototype=new Atlantis.GameComponent;b.prototype.update=function(a){this.previousKeysState=this.keysState;this.keysState=this.game.keyboard.getState()};b.prototype.pressed=function(a){return this.keysState.isKeyDown(a)};b.prototype.released=function(a){return this.keysState.isKeyUp(a)};b.prototype.justPressed=function(a){return this.keysState.isKeyUp(a)&&
this.previousKeysState.isKeyDown(a)};b.prototype.justReleased=function(a){return this.keysState.isKeyDown(a)&&this.previousKeysState.isKeyUp(a)};b.prototype.up=function(){return this.pressed(a.Up)};b.prototype.down=function(){return this.pressed(a.Down)};b.prototype.left=function(){return this.pressed(a.Left)};b.prototype.right=function(){return this.pressed(a.Right)};b.prototype.enter=function(){return this.pressed(a.Enter)};b.prototype.space=function(){return this.pressed(a.Space)};b.prototype.escape=
function(){return this.pressed(a.Escape)};b.prototype.control=function(){return this.pressed(a.Control)};b.prototype.shift=function(){return this.pressed(a.Shift)};b.prototype.tab=function(){return this.pressed(a.Tab)};return b}();Atlantis=window.Atlantis||{};Atlantis.Application={};
Atlantis.GameApplication=function(){var a=function(a,c,d){Atlantis.Game.call(this,a,c,d);this.stateManager=new Atlantis.StateManager(this);this.components.add(this.stateManager);var e=this;Atlantis.Application={loadLevel:function(a){return e.stateManager.loadLevel(levelName)},Game:this,ContentManager:this.content,Components:this.components,Keyboard:null,Width:a,Height:c,StateManager:this.stateManager}};a.prototype=new Atlantis.Game;a.prototype.initialize=function(){Atlantis.Game.prototype.initialize.call(this);
var a=new Atlantis.KeyboardComponent(this);this.components.add(a);Atlantis.Application.Keyboard=a;Atlantis.Application.Pointer=this.pointer};return a}();Atlantis=window.Atlantis||{};
...
0)};Atlantis.SpriteAnimator=function(){this.animations={};this.spritesheetLength=this.nbSpriteY=this.nbSpriteX=this.textureHeight=this.textureWidth=this.spriteHeight=this.spriteWidth=0;this.currentAnimationName=""};Atlantis.SpriteAnimator.prototype.initialize=function(a,b,c,d){this.animations={};this.spriteWidth=a;this.spriteHeight=b;this.textureWidth=c;this.textureHeight=d;this.nbSpriteX=this.textureWidth/this.spriteWidth;this.nbSpriteY=this.textureHeight/this.spriteHeight;this.spritesheetLength=
this.nbSpriteX*this.nbSpriteY;this.currentAnimationName=""};Atlantis.SpriteAnimator.prototype.add=function(a,b,c){var d=b.length;c=new Atlantis.SpriteAnimation(d,c);if(b instanceof Atlantis.Rectangle)c.rectangles=b;else for(var e=0;e<d;e++){var g=b[e]%this.nbSpriteX,f=Math.floor(b[e]/this.nbSpriteX),g=0<f?g%(this.nbSpriteX*f):g%this.nbSpriteX;c.rectangles[e]=new Atlantis.Rectangle(g*this.spriteWidth,f*this.spriteHeight,this.spriteWidth,this.spriteHeight)}this.animations[a]=c};Atlantis.SpriteAnimator.prototype.play=
function(a){this.currentAnimationName=a;return this.animations[a].next()};Atlantis.SpriteAnimator.prototype.getCurrentAnimation=function(){return""!==this.currentAnimationName?this.animations[this.currentAnimationName]:null};Atlantis.SpriteAnimator.prototype.update=function(a,b){""!==this.currentAnimationName&&this.animations[this.currentAnimationName].update(a)};Atlantis.SpriteAnimator.prototype.checkForIDLEAnimation=function(a){return""!==this.currentAnimationName&&0==a.x&&0==a.y?this.animations[this.currentAnimationName].rectangles[0]:
null}})();Atlantis=window.Atlantis||{};
Atlantis.Sprite=function(){var a=function(a,c){this.name="GameObject";this.visible=this.enabled=!0;this.texture=null;this.textureName="string"===typeof a?a:"";this.assetLoaded=!1;this.rectangle=new Atlantis.Rectangle;this.sourceRectangle=new Atlantis.Rectangle;this.direction=new Atlantis.Vector2;this.lastPosition=new Atlantis.Vector2;this.lastDistance=new Atlantis.Vector2;this.acceleration=new Atlantis.Vector2(1,1);this.velocity=new Atlantis.Vector2;this.maxVelocity=1;this.viewport=new Atlantis.Rectangle;
this.isFullyLoaded=this.acrossScreen=this.insideScreen=!1;this.spriteAnimator=new Atlantis.SpriteAnimator;this.hasAnimation=!1;this.elapsedTime=0;c=c||{};for(var d in c)this[d]=c[d];this._reqPrepareAnims=this._reqSize=null;this._reqAddAnims=[]};a.prototype.initialize=function(){this.viewport=new Atlantis.Rectangle(0,0,Atlantis.Application.Width,Atlantis.Application.Height)};a.prototype.loadContent=function(a,c){c="function"===typeof c?c:function(){};if(""!=this.textureName&&!1==this.assetLoaded){var d=
this;this.texture=a.load(this.textureName,function(a){d.rectangle.width=a.width;d.rectangle.height=a.height;d.assetLoaded=!0;d._reqPrepareAnims&&d.prepareAnimation(d._reqPrepareAnims.width,d._reqPrepareAnims.height);if(d._reqAddAnims.length){a=0;for(var b=d._reqAddAnims.length;a<b;a++)d.addAnimation(d._reqAddAnims[a].name,d._reqAddAnims[a].framesIndex,d._reqAddAnims[a].frameRate)}d._reqSize&&d.setSize(d._reqSize.width,d._reqSize.height);c(d)})}else c(this)};a.prototype.prepareAnimation=function(a,
c){if(this.assetLoaded){this.hasAnimation=!0;var d=c||a;this.spriteAnimator.initialize(a,d,this.texture.width||this.rectangle.width,this.texture.height||this.rectangle.height);this.rectangle.width=a;this.rectangle.height=d}else this._reqPrepareAnims={width:a,height:c}};a.prototype.addAnimation=function(a,c,d){this.assetLoaded?(this.spriteAnimator.add(a,c,d),this.sourceRectangle=this.spriteAnimator.animations[a].rectangles[0]):this._reqAddAnims.push({name:a,framesIndex:c,frameRate:d})};a.prototype.play=
function(a){this.assetLoaded&&(this.sourceRectangle=this.spriteAnimator.play(a))};a.prototype.update=function(a){this.enabled&&(this.elapsedTime+=a.getElapsedTime(),this.lastDistance.x=this.rectangle.x-this.lastPosition.x,this.lastDistance.y=this.rectangle.y-this.lastPosition.y,this.lastPosition.x=this.rectangle.x,this.lastPosition.y=this.rectangle.y,this.rectangle.x+=this.velocity.x*this.acceleration.x,this.rectangle.y+=this.velocity.y*this.acceleration.y,this.velocity.multiply(this.maxVelocity),
this.hasAnimation&&this.assetLoaded&&(this.spriteAnimator.update(a),0==this.lastDistance.x&&0==this.lastDistance.y&&""!==this.spriteAnimator.currentAnimationName&&(this.sourceRectangle=this.spriteAnimator.getCurrentAnimation().rectangles[0])))};a.prototype.postUpdate=function(a){this.enabled&&(this.direction.x=this.rectangle.x-this.lastPosition.x,this.direction.y=this.rectangle.y-this.lastPosition.y,this.insideScreen?(this.rectangle.x<this.viewport.x?(this.rectangle.x=this.viewport.x,this.velocity.multiply(0)):
...
(this.rectangle.x=this.viewport.x),this.rectangle.getBottom()<this.viewport.y?this.rectangle.y=this.viewport.height:this.rectangle.y>this.viewport.height&&(this.rectangle.y=this.viewport.y)))};a.prototype.draw=function(a,c){this.postUpdate(a);this.visible&&this.assetLoaded&&(this.hasAnimation?c.drawImage(this.texture,this.sourceRectangle.x,this.sourceRectangle.y,this.sourceRectangle.width,this.sourceRectangle.height,this.rectangle.x,this.rectangle.y,this.rectangle.width,this.rectangle.height):c.drawImage(this.texture,
this.rectangle.x,this.rectangle.y,this.rectangle.width,this.rectangle.height))};a.prototype.setSize=function(a,c){this.assetLoaded?(this.rectangle.width=a||this.rectangle.width,this.rectangle.height=c||this.rectangle.height):this._reqSize={width:a,height:c}};a.prototype.isActive=function(){return this.enabled&&this.visible};a.prototype.setActive=function(a){this.visible=this.enabled=a};a.prototype.move=function(a,c){this.rectangle.x=a;this.rectangle.y=c};a.prototype.translate=function(a,c){this.rectangle.x+=
a;this.rectangle.y+=c};a.prototype.getX=function(){return this.rectangle.x};a.prototype.getY=function(){return this.rectangle.y};a.prototype.getWidth=function(){return this.rectangle.width};a.prototype.getHeight=function(){return this.rectangle.height};a.prototype.setDirection=function(a){this.direction.x=x;this.direction.y=y};a.prototype.getDirection=function(){return this.direction};a.prototype.getName=function(){return this.name};a.prototype.setName=function(a){this.name=a};a.prototype.getBoundingRect=
function(){return this.rectangle};return a}();Atlantis=window.Atlantis||{};
Atlantis.SpriteGroup=function(){var a=function(){Atlantis.Sprite.call(this);this.entities=[]};a.prototype=new Atlantis.Sprite;a.prototype.initialize=function(){for(var a=0,c=this.entities.length;a<c;a++)this.entities[a].initialize()};a.prototype.loadContent=function(a){for(var c=0,d=this.entities.length;c<d;c++)this.entities[c].loadContent(a)};a.prototype.update=function(a){if(this.enabled)for(var c=0,d=this.entities.length;c<d;c++)this.entities[c].enabled&&this.entities[c].update(a)};a.prototype.draw=
function(a,c){if(this.visible)for(var d=0,e=this.entities.length;d<e;d++)this.entities[d].visible&&this.entities[d].draw(a,c)};a.prototype.add=function(a){if(a instanceof Array)for(var c=0,d=a.length;c<d;c++)this.entities.push(a[c]);else this.entities.push(a)};a.prototype.remove=function(a){var c=null;if(a instanceof Atlantis.Entity){var d=this.entities.indexOf(a);-1<d&&(c=this.entities[d],this.entities.splice(d,1))}else-1<a&&(c=this.entities[d],this.entities.splice(d,1));return c};a.prototype.get=
function(a){var c=null;-1<a&&(c=this.entities[a]);return c};a.prototype.clear=function(){this.entities.length=0};return a}();
