...
Atlantis.Vector4.lerp=function(a,b,c){a=new Vector4(a);a.lerp(b,c);return a};Atlantis.Vector4.prototype.toString=function(){return["x: ",this.x," y: ",this.y," z: ",this.z," w: ",this.w].join("")};Atlantis=window.Atlantis||{};Atlantis.Keys={Up:38,Down:40,Left:37,Right:39,Space:32,Tab:9,Shift:16,Alt:18,Control:17,Escape:27,Enter:13,F1:112,F2:113,F3:114,F4:115,F5:116,F6:117,F7:118,F8:119,F9:120,F10:121,F11:122,F12:123,BackSpace:8,Home:36,End:35,Suppr:46,PageUp:33,PageDown:34,Insert:45,Pause:19,Numpad1:97,Numpad2:98,Numpad3:99,Numpad4:100,Numpad5:101,Numpad6:102,Numpad7:103,Numpad8:104,Numpad9:105,Numpad0:96,Super:91,Num1:49,Num2:50,Num3:51,Num4:52,Num5:53,Num6:54,Num7:55,Num8:56,Num9:57,Num0:48};Atlantis=window.Atlantis||{};Atlantis.KeyboardState=function(a){this.keys=[];for(var b=0,c=a.length;b<c;b++)this.keys.push(a[b])};Atlantis.KeyboardState.prototype.clone=function(){return new Atlantis.Input.KeyboardState(this.keys)};Atlantis.KeyboardState.prototype.isKeyDown=function(a){return!0===this.keys[a]};Atlantis.KeyboardState.prototype.isKeyUp=function(a){return!1===this.keys[a]};
...
Math.min(1,a.wheelDelta||-a.detail))};a.addEventListener("mousedown",c,!1);a.addEventListener("mousemove",c,!1);a.addEventListener("mouseup",c,!1);a.addEventListener("click",c,!1);a.addEventListener("mousewheel",d,!1);a.addEventListener("DOMMouseScroll",d,!1)};Atlantis.Mouse.prototype.getState=function(){return new Atlantis.MouseState(this._x,this._y,this._scroll,this._buttons)};Atlantis=window.Atlantis||{};
